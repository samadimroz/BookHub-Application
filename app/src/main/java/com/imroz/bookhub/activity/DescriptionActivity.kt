...
import com.imroz.bookhub.database.BookDatabase
import com.imroz.bookhub.database.BookEntity
                    ...
                    if (success){
                        ...
                        btnAddToFav.setOnClickListener{
                            if (!DBAsyncTask(applicationContext, bookEntity, 1).execute().get()){
                                ...
                                val ssync= DBAsyncTask(applicationContext, bookEntity, 2).execute()
                                val result= ssync.get()
                                if (result){
